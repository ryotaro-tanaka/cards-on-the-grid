...
10. カード実装フェーズ（仕様v0.4準拠）を開始し、まずMove/Assault/Arrowrain/Mine/Stealingを優先実装する

---

## 全体進捗サマリ（2026-02-21 15:00更新 / UTC）

- **新規（仕様確定）**: カード仕様の主要未確定点を `game_rules.md v0.4` で確定（手札上限時の捨て→ドロー、Mine設置制約、Recharge対象制約、RNG/Move/Stealing方針）
